            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="group text-center p-6 rounded-2xl hover:bg-green-50/50 transition-all duration-300">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Control your digital identity with cryptographic keys that no corporation can revoke or control.
                </p>
              </div>
              ...
              <div className="group text-center p-6 rounded-2xl hover:bg-green-50/50 transition-all duration-300">
                ...
                <h3 className="font-bold text-slate-800 mb-3 text-lg">Truly Decentralized</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
